...
//   header?: string;
//   paragraph?: string | TinaMarkdownContent;
...
//       {/* Left Info with scroll-triggered fade-in */}
//       <motion.div
...
//           {header}{' '}
//           <span className="text-[#FFDA66]">us</span>
//         </h2>

//         {paragraph && (
//           <div className="mt-4">
//             {typeof paragraph === 'string' ? (
//               <p className="text-white text-[13px] md:text-[16px] lg:text-[19px]">
//                 {paragraph}
//               </p>
//             ) : (
...
//             <p className="mt-1 font-bold text-[25px] md:text-[28px] lg:text-[33px] text-white">
//               {contactEmail}
//             </p>
//           </div>
//         </div>
...
//       {/* Right Form with scroll-triggered fade-in */}
//       <motion.div
...
//             <div className="mt-4">
//               {typeof paragraph === 'string' ? (
//                 <p className="text-white text-[13px] md:text-[16px] lg:text-[19px]">{paragraph}</p>
//               ) : (
//                 <div className="text-white text-[13px] md:text-[16px] lg:text-[19px]">
//                   <TinaMarkdown content={paragraph} />
//                 </div>
